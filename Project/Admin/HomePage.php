...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../Assests/Templates/Admin/assets/vendors/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet" href="../Assests/Templates/Admin/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="../Assests/Templates/Admin/assets/css/style.css">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="../Assests/Templates/Admin/assets/images/favicon.png" />
  </head>
  <body>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="../Assests/Templates/Admin/assets/images/faces/face28.png" alt="image">
                </div>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                <span class="icon-bg"><i class="mdi mdi-crosshairs-gps menu-icon"></i></span>
                <span class="menu-title">FamerList</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="FarmerListVerification.php">NewFarmers</a></li>
                  <li class="nav-item"> <a class="nav-link" href="FarmerAcceptedList.php">Verified Farmers</a></li>
                  <li class="nav-item"> <a class="nav-link" href="FarmerRejectedList.php">Rejected Farmers</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="ViewComplaint.php">ViewComplaint</a></li>
                  <li class="nav-item"> <a class="nav-link" href="ReplyedComplaint.php">Replyed Complaints</a></li>
                  <!-- <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> -->
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="AdminRegistration.php"></i></span>
    ...
    <script src="../Assests/Templates/Admin/assets/vendors/chart.js/Chart.min.js"></script>
    <script src="../Assests/Templates/Admin/assets/vendors/jquery-circle-progress/js/circle-progress.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="../Assests/Templates/Admin/assets/js/off-canvas.js"></script>
    <script src="../Assests/Templates/Admin/assets/js/hoverable-collapse.js"></script>
    <script src="../Assests/Templates/Admin/assets/js/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="../Assests/Templates/Admin/assets/js/dashboard.js"></script>
