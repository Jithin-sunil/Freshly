...
<link rel="stylesheet" href="../Assests/Templates/Search/bootstrap.min.css">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="text-center">
                        <img src="../Assests/Templates/Search/loader.gif" id='loder' width="200" style="display: none"/>
                    </div>
...
<script src="../Assests/Templates/Search/jquery.min.js"></script>
        <script src="../Assests/Templates/Search/bootstrap.min.js"></script>
<script src="../Assests/Templates/Search/popper.min.js"></script>
...
function changeSub()
            {
                ...
                function get_filter_text(category)
                {
                    var filterData = [];
            ...
            function productCheck(){
                    ...
                    // var mobile = get_filter_text('mobile');
					var name = document.getElementById('txt_name').value;
					


                    $.ajax({
                        url: "../Assests/Ajax/AjaxSearchProduct.php?action=" + action +"&category="+category  +"&name=" + name ,
                        success: function(response) {
