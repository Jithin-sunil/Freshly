<?php
	...
	if(isset($_POST["btnsubmit"]))
	{
			...
			move_uploaded_file($temp,'../Assests/Files/FarmerDocs/'.$photo);
			$proof = $_FILES["proof"]["name"];
			$temp=$_FILES["proof"]["tmp_name"];
			move_uploaded_file($temp,'../Assests/Files/FarmerDocs/'.$proof);
	
	$insQry="insert into tbl_farmers(farmer_name,farmer_contact,farmer_email,farmer_address,farmer_password,place_id,farmer_photo,farmer_proof) values('$name','$contact','$email','$address','$password','$place','$photo','$proof')";
...
<script>
  ...
  function emailCheck(email) {
    $.ajax({
      url: "../Assests/Ajax/AjaxEmail.php?email=" + email,
      success: function (result) {
		  alert(result)
      }
    });
